# Contributing to stapel-billing
...
```bash
git clone https://github.com/usestapel/stapel-billing.git && cd stapel-billing
...
The packages use a flat layout (`package-dir = {{"stapel_billing": "."}}`), so the
